  ...
  const reviews = [
    {
      ...
      name: "Budi Santoso",
      rating: 5,
      comment: "Dimsumnya enak banget! Teksturnya lembut dan rasanya autentik. Sudah pesan berkali-kali dan selalu konsisten kualitasnya.",
    ...
    },
    {
      ...
      name: "Anita Wijaya",
      rating: 4,
      comment: "Pelayanan cepat dan packing rapi. Rasanya enak, hanya saja sedikit terlalu asin untuk selera saya. Tapi overall sangat memuaskan!",
    ...
    },
    {
      ...
      name: "Rudi Hartono",
      rating: 5,
      comment: "Paling suka siomay ikannya! Gurih dan fresh. Anak-anak saya sampai berebut kalau saya bawa pulang dimsum dari sini.",
    ...
    },
    {
      ...
      name: "Dewi Lestari",
      rating: 5,
      comment: "Saya pesan untuk acara arisan dan tamu-tamu semua memuji. Presentasinya juga bagus, harga sangat reasonable untuk kualitas premium.",
  ...
  return (
    <section className="relative py-20 bg-gradient-to-b from-amber-50 to-white overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <svg className="absolute top-20 right-20 w-16 h-16 text-amber-300/30" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/>
          <path d="M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z"/>
        </svg>
        <svg className="absolute bottom-20 left-20 w-20 h-20 text-red-300/20" viewBox="0 0 24 24" fill="currentColor">
          <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/>
          <path d="M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z"/>
        </svg>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            Apa Kata Mereka Tentang <span className="text-amber-600">SumSkuy</span>
          </h2>
          <div className="w-24 h-1.5 bg-gradient-to-r from-amber-400 to-red-400 mx-auto mb-6 rounded-full"></div>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Ulasan jujur dari pelanggan yang telah merasakan kelezatan dimsum kami
          </p>
        </div>
              ...
              <div className="flex flex-col items-center mb-8">
                <div className="relative mb-6">
                  <div className="w-32 h-32 rounded-full bg-gradient-to-br from-amber-100 to-amber-50 flex items-center justify-center shadow-inner border-2 border-amber-200">
                    <div className="text-5xl font-bold text-amber-700">{averageRating.toFixed(1)}</div>
                  </div>
                ...
                <div className="flex mb-4">
                  {[...Array(5)].map((_, i) => (
                    <svg
                      key={i}
                      className={`w-8 h-8 ${i < Math.floor(averageRating) ? 'text-amber-400' : 'text-gray-300'}`}
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                ...
                <p className="text-gray-500 text-center">Rata-rata rating dari pelanggan kami</p>
              </div>

              <div className="space-y-4 mb-8">
                {ratingDistribution.map(({star, count, percentage}) => (
                  <div key={star} className="flex items-center group">
                    <span className="w-12 text-gray-700 font-medium transition-all group-hover:text-amber-600">{star} ★</span>
                    ...
                    <span className="w-8 text-right text-gray-600 text-sm font-medium transition-all group-hover:text-amber-700">{count}</span>
                  </div>
                ))}
              </div>
                  ...
                  {reviews.map((review) => (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row items-start mb-4">
                        ...
                        <div>
                          <h4 className="text-xl font-bold text-gray-900 group-hover:text-amber-700 transition-colors duration-300">{review.name}</h4>
                          <div className="flex items-center mb-1">
                            <svg className="w-4 h-4 text-gray-500 mr-1 group-hover:text-amber-500 transition-colors duration-300" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                            </svg>
                            <span className="text-gray-500 text-sm group-hover:text-amber-600 transition-colors duration-300">{review.location}</span>
                          </div>
                          <span className="text-gray-400 text-sm group-hover:text-gray-500 transition-colors duration-300">{review.date}</span>
                        </div>
                      </div>
                      ...
                      <div className="mt-4 flex justify-end">
                        <div className="flex space-x-1">
                          {[...Array(5)].map((_, i) => (
                            <svg
                              key={i}
                              className={`w-5 h-5 ${i < review.rating ? 'text-amber-400 group-hover:text-amber-500' : 'text-gray-300'}`}
                              fill="currentColor"
                              viewBox="0 0 20 20"
                            >
                              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
...
function Hero() {
  ...
  const images = [
    "/hero image slider one.jpg",
    "/hero image slider two.jpg"
  ];
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setTimeout(() => {
        ...
        setFade(true);
      }, 300); // Waktu transisi diperpendek
    }, 3000);
  ...
  return (
    <section className="relative h-screen overflow-hidden bg-gradient-to-r from-red-50 to-amber-50">
      ...
      <div className="container mx-auto px-6 h-full flex flex-col justify-center items-center relative z-10">
        ...
        {/* Gambar dimsum dengan animasi slider */}
        <div className="mt-16 relative w-64 h-64">
          <div
            className="w-full h-full bg-white rounded-full shadow-xl flex items-center justify-center relative"
            style={{
              animation: "spin 10s linear infinite" // Rotasi dipercepat
            }}
          >
            <img
              src={images[currentImage]}
              alt="Dimsum Special"
              className={`w-56 h-56 object-cover rounded-full border-4 border-amber-300 absolute transition-opacity duration-300 ${fade ? 'opacity-100' : 'opacity-70'}`} // Opacity tidak sampai 0
            />
          </div>
          <div
