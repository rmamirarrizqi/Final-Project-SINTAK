    ...
    <section className="py-20 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Temukan lokasi SumSkuy terdekat dan nikmati pengalaman kuliner
            dimsum autentik
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white/70 backdrop-blur-xl rounded-3xl p-6 border border-white/30 shadow-lg">
            ...
            <div className="bg-white/70 backdrop-blur-xl rounded-3xl overflow-hidden border border-white/30 shadow-lg">
              ...
              <div className="h-64 bg-gradient-to-br from-emerald-100 to-teal-200 flex items-center justify-center relative">
                ...
                <div className="absolute top-4 right-4">
                  <button className="bg-white/80 backdrop-blur-sm p-2 rounded-lg hover:bg-white transition-colors">
                    <svg
              ...
              <div className="p-6">
                ...
                <div className="flex gap-3 mt-6">
                  <button className="flex-1 bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2">
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      stroke="currentColor"
                  ...
                  <a
                    href={`tel:${selectedLocation.phone}`}
                    className="flex-1 border border-emerald-300 text-emerald-600 hover:bg-emerald-50 font-semibold py-3 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
